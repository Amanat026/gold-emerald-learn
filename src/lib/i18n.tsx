...
const en = {
  ...
  form: {
    ...
    send: "Send message",
    sending: "Sending…",
    note: "Your message goes straight to our inbox at englishcore26@gmail.com — we reply within 24 hours.",
    toastError: "Please fix the highlighted fields",
    toastSuccess: "Message sent! We'll get back to you within 24 hours.",
    toastSendError: "Couldn't send your message — please try again or reach us on WhatsApp.",
    errors: {
...
const bn: Translation = {
  ...
  form: {
    ...
    note: "আপনার বার্তা সরাসরি englishcore26@gmail.com-এ পৌঁছে যাবে — আমরা ২৪ ঘণ্টার মধ্যে উত্তর দেব।",
    toastError: "চিহ্নিত ঘরগুলো ঠিক করুন",
    toastSuccess: "বার্তা পাঠানো হয়েছে! আমরা ২৪ ঘণ্টার মধ্যে আপনার সাথে যোগাযোগ করব।",
    toastSendError: "বার্তা পাঠানো যায়নি — আবার চেষ্টা করুন অথবা হোয়াটসঅ্যাপে যোগাযোগ করুন।",
    errors: {
